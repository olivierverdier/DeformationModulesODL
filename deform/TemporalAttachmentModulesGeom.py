...
class FunctionalModulesGeom(Functional):
    ...
    def __init__(self,lam, nb_time_point_int, template, data, data_time_points, forward_operators,Norm, Module, domain=None):
        """
        ...
        if domain is None:
            domain = odl.ProductSpace(
                    ...
                    self.Module.Contspace,self.N+1))
    ...
    def gradient(self):
        ...
        class FunctionalModulesGeomGradient(Operator):
